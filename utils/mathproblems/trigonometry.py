...
def generate_trigonometry_problem():
    ...
    if operation == "tan":
        answer = tan_sign(angle) if angle % 180 != 90 else text("undefined")
    elif operation == "cos":
    ...
    question = f"{text("math", "what_is")} {text("the")} {text("math", "sign_of")} {operation}({display})? (+, -, 0 or {text("undefined")})"
