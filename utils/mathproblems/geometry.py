...
def generate_geometry_problem():
    ...
    if shape == 'square':
        ...
        question = text("math", "square_question", operation=text("math", operation), side=side)
        ...
        question = text("math", "rectangle_question", operation=text("math", operation), length=length, width=width)
        ...
        question = text("math", "triangle_question", base=base, height=height)
        answer = 0.5 * base * height
    
    elif shape == 'pentagon':
        length = random.randint(1, 100)
        question = text("math", "pentagon_question", length=length)
        answer = length*5
        ...
        height = random.randint(1, 20)
        question = text("math", "trapezoid_question", base=base, base2=base2, height=height)
