...
async def blackjack(self, ctx, bet: int|None = None):
    ...
    async with db.transaction() as cur:
        ...
        dealer_value = calculate_value(game.dealer_hand.cards)
